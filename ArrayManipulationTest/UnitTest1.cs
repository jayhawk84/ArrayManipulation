...
namespace ArrayManipulationTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void TestSortingArrays1()
        {
            //TDD Test Driven Development
            int[] myTestArray = { 100, 400, 22, 67, 66, 54, 45, 66, 32, 43 };
            int[] myRotatedArray = { 54, 45, 66, 32, 43, 100, 400, 22, 67, 66 };
        ...
        [TestMethod]
        public void TestSortingArrays2()
        {
            //TDD Test Driven Development
            int[] myTestArray = { 100, 400, 22, 67, 66, 54, 45, 66, 32, 43 };
            int[] mySortedArray = { 400, 100, 67, 66, 66, 54, 45, 43, 32, 22 };
            CollectionAssert.AreEqual(mySortedArray, SortingArrays.SortedArray(myTestArray));
